...
public class DbBean1 {
	...
	public boolean ifGetThisDay(String date) throws Exception {
		...
		try {
			...
			sql = "SELECT count(*) as total FROM `cjzt` WHERE `cjrq` = '"
					+ date + "' and cjlx='mrjj' and bmcjzt=1";
	...
	public boolean ifGetThisDayIndex(String date) throws Exception {
		...
		try {
			...
			sql = "SELECT count(*) as total FROM `cjzt` WHERE `cjrq` = '"
					+ date + "' and cjlx='mrjj' and indexcjzt=1";
	...
	public List<String[]> getWaitingBanMianList(String bmdate) throws Exception {
		...
		try {
			...
			sql = "select * from banmian where lx='mrjj' and bmdate='" + bmdate
					+ "' and getdone=0";
	...
	public List<String[]> getNewsByDate(String date) throws Exception {
		...
		try {
			...
			sql = "select d.id,b.content bm,n.content bt,d.content,d.imgurl from detaillist d inner join newslist n on n.id=d.newsid inner join banmian b on b.id=n.bmid and d.createdone=0 and b.lx='mrjj' and b.bmdate='"+date+"'";
