	...
	%>
		<div id="container">
			<form action="/blogType" method="get" name="modifyblog">
				<input type="hidden" name="opera" value="modify">
				<input type="hidden" name="url" value="2">
				<input type="hidden" name="t" value="<%=bt.getId() %>">
				...
				<select name="pid">
					...
					<%=Tools.blogTypeList2Str(blogTypeList,bt.getParentId()) %>
					<%} %>
				</select>
				<div class="container-title">
					标题：
				</div>
				<input type="text"	name="tname" value="<%=bt.getName() %>"> 
				<div class="container-content">
					内容：
				</div>
					<input name="info" value="<%=bt.getInfo() %>">
				<div id="typelist">
				</div>
