...
<%
	...
	int MAX_FILE_SIZE = 1024 * 1024 * 2;// 1MB
	int MAX_FILES = 5;
	...
	if (isMultipart) {
		...
		try {
			...
			out.print("<script type=text/javascript>window.parent.hideLoading();window.parent.buildAvatarEditor('"+df.getId()+"','"+url+"','photo');</script>");
